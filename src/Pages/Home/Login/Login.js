...
const handleLogin = (data) => {
    ...
    return (
        <div>
            ...
            <div className="">
                <img src="https://static.vecteezy.com/system/resources/thumbnails/002/223/426/small_2x/banner-design-of-folder-with-a-password-and-username-security-for-personal-data-protection-illustration-concept-be-used-for-landing-page-template-ui-web-mobile-app-poster-banner-website-free-vector.jpg" alt="" />
            </div>
           ...
           'w-full max-w-sm p-6 m-auto mx-auto bg-white rounded-md shadow-md border-2 '>
             <h2 className='text-center text-2xl font-medium'> Please LogIn</h2>
                    ...
                    <p className=" text-base mt-1 font-light text-start text-gray-600">New to Wooden OLX <Link to='/signup' className="font-medium text-primary dark:text-gray-200 hover:underline">Create New Account </Link></p>
